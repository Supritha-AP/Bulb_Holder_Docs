...
# 2 "<built-in>" 2
# 1 "PIC10_PIC12_HEFlash.c" 2
# 51 "PIC10_PIC12_HEFlash.c"
...
# 52 "PIC10_PIC12_HEFlash.c" 2


uint8_t SaveInt;
# 89 "PIC10_PIC12_HEFlash.c"
        uint16_t ReadWrite_HEFlash(uint8_t rw, uint8_t data, uint16_t rowstartaddr) {
            uint16_t addr;
